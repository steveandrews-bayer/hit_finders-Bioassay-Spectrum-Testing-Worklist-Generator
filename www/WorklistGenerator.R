...
{
  print(targetPPMsForInsect)
  print(targetPPMsForInsect[[1]])
  print(targetPPMsForInsect[1])
  dilNum <- 1
...
create_worklists <- function(numProteins, numNormalPlates, numHemipPlates, numLygusPlates, proteinNames)
{
  ...
  {
    startingPlates[insectType] <- add_volumes(templatePlate, startingHighConcs[[insectType]], startingLowConcs[[insectType]], targetPPMs[[insectType]], targetVolumes[[insectType]])
  }
